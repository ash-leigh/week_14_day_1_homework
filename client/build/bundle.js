...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieShowTimes = __webpack_require__(161);
	var sampleMovies = [{ id: 1, title: "  The Man Who Fell to Earth", url: "http://www.imdb.com/title/tt0074851?pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=1970868962&pf_rd_r=1WGGECSA7GPMH51FHRB2&pf_rd_s=right-2&pf_rd_t=15061&pf_rd_i=homepage&ref_=hm_otw_t0" }, { id: 2, title: "Don't Breathe", url: "http://www.imdb.com/title/tt4160708?pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=1970868962&pf_rd_r=1WGGECSA7GPMH51FHRB2&pf_rd_s=right-2&pf_rd_t=15061&pf_rd_i=homepage&ref_=hm_otw_t1" }, { id: 3, title: "Kubo and the Two Strings", url: "http://www.imdb.com/title/tt4302938?pf_rd_m=A2FGELUUNOQJNL&pf_rd_p=1970868962&pf_rd_r=1WGGECSA7GPMH51FHRB2&pf_rd_s=right-2&pf_rd_t=15061&pf_rd_i=homepage&ref_=hm_otw_t2" }];
	...
	var MoviesBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(MovieShowTimes, null)
	    );
	  }
	...
	var MoviesList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var movieNodes = this.props.data.map(function (movie) {
	      React.createElement(
	        Movie,
	        { id: movie.id, key: movie.id, url: movie.ur },
	        movie.title
	      );
	    });
	    return React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieShowTimes = React.createClass({
	  displayName: 'MovieShowTimes',
